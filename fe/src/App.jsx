...
import PersonalWellnessForm from "./components/PersonalWellnessForm.jsx"; // ✅ New Page
  ...
  return (
    <>
      <Routes>
        ...
        <Route path="/personal-wellness" element={<PersonalWellnessForm />} /> {/* ✅ Added New Route */}
        <Route path="/test" element={<h1 style={{ color: "black" }}>Routing Works!</h1>} />
